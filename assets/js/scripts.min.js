...
!function(c){c.fn.simpleJekyllSearch=function(e){var o=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! No hemos podido encontrar ningún resultado con eso que has escrito :(</p>"},e),l=o.jsonFormat.split(","),a=[],s=this,i=c(o.searchResults);function r(){i.children().remove()}o.jsonFile.length&&i.length&&c.ajax({type:"GET",url:o.jsonFile,dataType:"json",success:function(e,t,n){a=e,s.keyup(function(e){var t,n,s;c(this).val().length?(n=c(this).val(),s=[],c.each(a,function(e,t){for(e=0;e<l.length;e++)void 0!==t[l[e]]&&-1!==t[l[e]].toLowerCase().indexOf(n.toLowerCase())&&(s.push(t),e=l.length)}),t=s,r(),i.append(c(o.searchResultsTitle)),t.length?c.each(t,function(e,t){if(e<o.limit){for(var n=o.template,e=0;e<l.length;e++){var s=new RegExp("{"+l[e]+"}","g");n=n.replace(s,t[l[e]])}i.append(c(n))}}):i.append(o.noResults)):r()})},error:function(e,t,n){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(n)}})}}(Zepto);
